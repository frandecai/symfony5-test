...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/login'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY', 1 => 'ROLE_USER', 2 => 'ROLE_ADMIN'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/logout'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY', 1 => 'ROLE_USER', 2 => 'ROLE_ADMIN'], NULL);
